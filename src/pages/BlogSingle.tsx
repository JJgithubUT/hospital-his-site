          ...
          <div className="container-fluid">
            <div className="row slider-text align-items-center justify-content-center" data-scrollax-parent="true">
              <div className="col-md-8 mt-5 text-center col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                <p className="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span className="mr-2"><Link to="/">Home</Link></span> <span className="mr-2"><Link to="/blog">Blog</Link></span> <span>Blog Details</span></p>
                <h1 className="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Blog Details</h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 ftco-animate">
              ...
              <p>
                <img src="/template/images/image_6.jpg" alt="" className="img-fluid" />
              </p>
              ...
              <p>
                <img src="/template/images/image_8.jpg" alt="" className="img-fluid" />
              </p>
              ...
              <div className="about-author d-flex p-5 bg-light">
                <div className="bio align-self-md-center mr-5">
                  <img src="/template/images/person_1.jpg" alt="Image placeholder" className="img-fluid mb-4" />
                </div>
              ...
              <div className="pt-5 mt-5">
                ...
                <div className="comment-form-wrap pt-5">
                  ...
                  <form className="p-5 bg-light" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="col-md-4 sidebar ftco-animate">
              ...
              <div className="sidebar-box ftco-animate">
                ...
                <div className="block-21 mb-4 d-flex">
                  <a className="blog-img mr-4" style={{ backgroundImage: 'url(/template/images/image_1.jpg)' }}></a>
                  <div className="text">
                ...
                <div className="block-21 mb-4 d-flex">
                  <a className="blog-img mr-4" style={{ backgroundImage: 'url(/template/images/image_2.jpg)' }}></a>
                  <div className="text">
                    <h3 className="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                    <div className="meta">
                      <div><a href="#"><span className="icon-calendar"></span> July 12, 2018</a></div>
                ...
                <div className="block-21 mb-4 d-flex">
                  <a className="blog-img mr-4" style={{ backgroundImage: 'url(/template/images/image_3.jpg)' }}></a>
                  <div className="text">
                    <h3 className="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                    <div className="meta">
                      <div><a href="#"><span className="icon-calendar"></span> July 12, 2018</a></div>
